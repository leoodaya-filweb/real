...
$this->registerJs(<<< JS
    ...
    $('input[name="CertificationForm[transaction_type]"]').click(function() {
        KTApp.blockPage({
            overlayColor: '#000000',
            state: 'warning', // a bootstrap color
            message: 'Please wait...'
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(s) {
                var editor = tinymce.get('certificationform-content'); 
                editor.setContent(s.model.content);
                KTApp.unblockPage();
            },
            error: function(e) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="CertificationForm[transaction_type]" value="<?= $model->coi['id'] ?>" <?= ($model->coi['id'] == $model->transaction_type)? 'checked': '' ?>>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                            ...
                                            <div class="col-md-4">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="CertificationForm[transaction_type]" value="<?= $model->fc['id'] ?>" <?= ($model->fc['id'] == $model->transaction_type)? 'checked': '' ?>>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
                                            ...
                                            <div class="col-md-4">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio">
                                                            <input type="radio" name="CertificationForm[transaction_type]" value="<?= $model->coad['id'] ?>" <?= ($model->coad['id'] == $model->transaction_type)? 'checked': '' ?>>
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
