...
$this->params['breadcrumbs'][] = $indexPage ?? ['label' => 'Transactions', 'url' => $model->indexUrl];
...
$this->params['breadcrumbs'][] = 'Social Pension';
$this->params['searchModel'] = $searchModel ?? new TransactionSearch();
        ...
        <div class="col">
            <?php $this->beginContent('@app/views/layouts/_card_wrapper.php', [
                ...
                <div class="requirements">
                    <?= Value::widget([
                        'label' => '1) Senior Citizens ID (1 Original)',
                        'content' => '<em>Where to secure: </em>Office of the Senior Citizen’s Affairs'
                    ]) ?>

                    <div class="my-5"></div>

                    <?= Value::widget([
                        'label' => '2) Endorsement from the President of the Senior Citizens Association in the respective Barangay (1 Original)',
                        'content' => '<em>Where to secure: </em>Senior Citizens Association President in the respective Barangay'
                    ]) ?>
                </div>
                <hr>
                <section class="mt-10">
                        ...
                        <div class="col-md-12">
                            ...
                            <?= Webcam::widget([
                                ...
                                'ajaxSuccess' => <<< JS
                                    ...
                                    $('.document-container-holder').prepend('<input class="app-hidden file-hidden-input-'+ s.file.token +'" type="text" name="SocialPensionForm[files][]" value="'+ s.file.token +'">'); 
                                JS
                            ]) ?>
                        </div>
                    </div>
