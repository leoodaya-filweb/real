...
$this->params['breadcrumbs'][] = ['label' => 'Senior Citizen ID Application', 'url' => ['transaction/view', 'token'=>Yii::$app->request->get('token')]];
                            ...
                            <?php $this->beginContent('@app/views/file/_row-header.php'); ?>
                                <?= Html::foreach($model->imageFiles, function($file) {
                                    return $this->render('/file/_row', [
                                        'model' => $file
                                    ]) . Html::input('text', 'SeniorCitizenIdForm[files][]', $file->token,
