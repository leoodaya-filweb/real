...
/* @var $dataProvider yii\data\ActiveDataProvider */
 ...
 $searchModel->searchAction = ['specialsurvey/campaign-progress'];


$this->title = 'Registration & Campaign Progress';
$this->params['breadcrumbs'][] = $this->title;
$this->params['searchModel'] = $searchModel; 
$this->params['searchForm'] = 'testvv';
$this->params['showCreateButton'] = false;//true; 
$this->params['showExportButton'] = false; //true;
$this->params['activeMenuLink'] = '/specialsurvey/campaign-progress';
...
$url = ['specialsurvey/campaign-progress','print' => true];
