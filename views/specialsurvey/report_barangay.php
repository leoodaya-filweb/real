...
$this->title = 'Socio Economic Survey Reports per Barangay';
$this->params['breadcrumbs'][] = $this->title;
$this->params['searchModel'] = $searchModel; 
$this->params['showCreateButton'] = false; 
$this->params['showExportButton'] = false;
$this->params['activeMenuLink'] = '/specialsurvey/report-per-barangay';

$url = ['specialsurvey/report-per-barangay','print' => true];
...
$print_url = Url::to([
	'specialsurvey/report-per-barangay',
	'print' => true,
	'date_range' => $searchModel->date_range,
	'status' => 'Active'
], true);
