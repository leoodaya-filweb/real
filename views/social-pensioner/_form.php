...
$this->registerJs(<<< JS
  ...
  function parseDate(str) {
   ...
   return (matchesPadded || matchesNonPadded) ? d : null;
    ...
    Inputmask().mask("socialpensioner-birth_date"); 
...
?>
<?php $form = ActiveForm::begin(['id' => 'social-pensioner-form']); ?>
	            ...
	            <div class="col-md-4">
					...
					<?= Webcam::widget([
						...
						'ajaxSuccess' => <<< JS
							...
							$('.document-container-holder').prepend('<input class="app-hidden file-hidden-input-'+ s.file.token +'" type="text" name="SocialPensioner[documents][]" value="'+ s.file.token +'">'); 
						JS
					]) ?>
	                ...
	                <?php $this->beginContent('@app/views/file/_row-header.php'); ?>
	                    <?= Html::foreach($model->documentFiles, function($file) {
	                        return $this->render('/file/_row', [
	                            'model' => $file
	                        ]) . Html::input('text', 'SocialPensioner[documents][]', $file->token,
