...
<section>
	...
	<div class="row">
		<div class="col-md-6">
			...
			<?= Checkbox::widget([
			    'data' => App::keyMapParams('client_categories_sp', 'code', 'label'),
		...
		<div class="col-md-6">
				...
				<label>
				<?= $model->getAttributeLabel('benefit_code') ?>
			</label>
			<?= Checkbox::widget([
			    'data' => App::keyMapParams('benefit_code', 'code', 'label'),
			    'name' => 'Database[benefit_code][]',
			    'inputClass' => 'checkbox',
			    'checkedFunction' => function($key, $value) use ($model) {
			        return isset($model->benefit_code) && in_array($key, $model->benefit_code) ? 'checked': '';
			    }
			]) ?>
