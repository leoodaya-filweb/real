	...
	<div class="row">
		<div class="col-md-12">
			<table class="table">
				<thead>
					<tr>
						<th style="text-transform: none;" >No.</th>
						<th style="text-transform: none;" >Name</th>
						<th style="text-transform: none;" >Birthdate</th>
						<th style="text-transform: none;" >Age</th>
						<th style="text-transform: none;" >Civil Status</th>
						<th style="text-transform: none;" >Educational Attainment</th>
						<th style="text-transform: none;" >Relationship</th>
						<th style="text-transform: none;" >Occupation</th>
						<th style="text-transform: none;" >Income</th>
					</tr>
				</thead>
				<tbody>
					<?= Html::foreach($model->family_composition, function($data, $key) {
						return <<< HTML
							<tr>
								...
								<td> 
									<input class="form-control" type="text" value="{$data['educational_attainment']}" list="datalist-educational-attainment" name="Database[family_composition][{$key}][educational_attainment]"> 
								</td>
