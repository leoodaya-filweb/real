...
<section>
	<div class="row">
		<div class="col-md-12">
			<h3 class="card-label">Case Info</h3>
			<hr/>
		</div>
	</div>
	...
	<div class="row">
			 ...
			 <?= BootstrapSelect::widget([
				...
				'model' => $model,
				'attribute' => 'vawc_case',
				'data' => ['Economic' => 'Economic', 'Physical' => 'Physical', 'Psychological/Emotional' => 'Psychological/Emotional', 'Sexual'=>'Sexual'],
			]) ?>
			...
			<div class="col-md-4">
			 <?php 
	    	echo  $form->field($model, 'perpetrator')->textInput([
				 'maxlength' => true
			 ]); 
			 ?>
			 </div>
			 	<div class="col-md-4">
			  <?php 
	    	echo  $form->field($model, 'perpetrator_relation')->textInput([
				 'maxlength' => true
			 ])->label('Relationship'); 
			 ?>
		 </div>
