...
$this->registerJs(<<< JS
    let selectedFile = 0,
        ...
        imgCreatedBy = $('#my-files #td-created_by'),
    ...
    $(document).on('click', imageContainer, function() {
        ...
        imgCreatedBy.text($(this).data('created_by'));
        ...
        let actionButtons = '<a href="'+ $(this).data('download-url') +'" class="btn btn-primary btn-sm">';
            ...
            actionButtons += '&nbsp; <a href="'+ $(this).data('viewer_url') +'" class="btn btn-outline-info btn-sm font-weight-bold" target="_blank"> View </a>';
...
<p class="lead font-weight-bolder">Total: <?= File::totalSize() ?></p>
