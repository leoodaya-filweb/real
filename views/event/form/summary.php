...
<div class="row">
    <div class="col">
        <div class="text-dark-50 line-height-lg">
            ...
            <div> <b>Category:</b> <?= $model->categoryLabel ?> </div>
            <div> <b>Date:</b>  
            ...
            <div> <b>Type:</b> <?= $model->eventTypeLabel ?> </div>
            <div> <b>Assistance Type:</b> <?= $model->assistanceTypeLabel ?> </div>
            <div> <b>Amount | Budget:</b> <?= App::formatter('asNumber', $model->amount) ?> </div>
        </div>
    </div>
    <div class="col">
        <?= Html::image($model->photo, ['w' => 200], ['class' => 'img-fluid']) ?>
    </div>
</div>
...
<div class="row">
    <div class="col">
        <div class="text-dark-50 line-height-lg">
            <?= Html::if(($beneficiaries = $model->beneficiaryData) != null, function() use($beneficiaries) {
                return Html::foreach($beneficiaries, function($beneficiary, $key) {
