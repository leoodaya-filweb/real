...
$this->registerJs(<<< JS
    ...
    $("#checkAll").click(function(){
      $('#barangay-checklist input:checkbox').not(this).prop('checked', this.checked);
    });
...
<?php $form = ActiveForm::begin(['id' => 'event-form']); ?>
    <div class="row" data-sticky-container>
                ...
                <div class="card" data-title="Barangay">
                    ...
                    <div id="barangay-container" class="collapse" data-parent="#accordion-filter">
                        <div class="card-body">
                               ...
                               <label class=""><input id="checkAll" type="checkbox"  name="check_all">  Select All</label>
                            
                            <span id="barangay-checklist">
                            <?= Filter::widget([
                                'form' => $form,
                                'model' => $searchModel,
        ...
        <div class="col total-beneficiaries-container">
