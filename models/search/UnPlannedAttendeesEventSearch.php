 ...
 */
class UnPlannedAttendeesEventSearch extends UnPlannedAttendeesEvent
{
    public $keywords;
    public $date_range;
    public $pagination;

    public $searchTemplate = 'un-planned-attendees-event/_search';
    public $searchAction = ['open/index'];
    public $searchLabel = 'Open Event';
    ...
    {
        $query = UnPlannedAttendeesEvent::find()
            ->select(['e.*'])
            ->with('eventCategory')
            ->alias('e')
            ->groupBy('e.id');
