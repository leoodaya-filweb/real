...
/**
 * SocialPensionerSearch represents the model behind the search form of `app\models\SocialPensioner`.
 */
class SocialPensionerSearch extends SocialPensioner
{
    public $keywords;
    public $date_range;
    public $pagination;

    public $searchTemplate = 'social-pensioner/_search';
    public $searchAction = ['social-pensioner/index'];
    public $searchLabel = 'Social Pensioner';
