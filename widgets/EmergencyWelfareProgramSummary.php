...
class EmergencyWelfareProgramSummary extends BaseWidget
{
    public $data;
    public $title;
    public $tableClass;
    ...
    public function init()
    {
        ...
        $this->data = $this->data ?: $this->searchModel->emergency_welfare_program_data();
    }

    public function run()
    {
        return $this->render('emergency-welfare-program-summary', [
            'data' => $this->data,
            ...
            'balik_probinsya' => $this->data['balik_probinsya'],
