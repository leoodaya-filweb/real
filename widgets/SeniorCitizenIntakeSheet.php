...
class SeniorCitizenIntakeSheet extends BaseWidget
{
    public $transaction;
    public $model;
    public $content;
    ...
    public function init()
    {
        ...
        $this->content = str_replace(array_keys($replace), array_values($replace), $template->senior_citizen_intake_sheet);
    }
    ...
    public function run()
    {
        ...
        return $this->render('senior-citizen-intake-sheet/index', [
