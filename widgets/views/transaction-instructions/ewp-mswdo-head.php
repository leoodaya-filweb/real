...
<ul>
    <li>
        Upload <?= Html::a('Whitecard', "{$transaction->viewUrlWhiteCard}") ?> 
        <?= Html::ifElse($transaction->white_card_status == Transaction::DOCUMENT_CLERK_CREATED, $checked, $xmark) ?>
    </li>
...
<!-- <em>The <b>approved</b> button will only visible after reviewing the (<?= Html::ifElse($transaction->isMedical, 4, 3) ?>) documents.</em> -->
