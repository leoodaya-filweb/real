    ...
    return Html::ifElse(isset($menu['group_menu']) && $menu['group_menu'],
        ...
        Html::ifElse(!empty($menu['sub']),
            ...
            function() use($menu, $controller, $viewParams) {
                ...
                // });
                // $class = Html::if($viewParams['activeMenuLink'] ?? $viewParams['controllerLink'], fn($activeMenuLink) => ($activeMenuLink == $menu['link']) ? 'menu-item-active': '');
                $class = App::if($viewParams['activeMenuLink'] ?? $viewParams['controllerLink'], fn ($al) => ($al == $menu['link']) ? 'menu-item-active': '');
