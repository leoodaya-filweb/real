...
<div class="">
	<table class="table-summary <?= $tableClass ?>" style="width: 100%;">
		<tbody>
			...
			<tr>
				<td style="<?= $fwbr_tc ?>">Emergency Welfare Program</td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_week']['Male']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_week']['Female']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_week']['Total']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_month']['Male']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_month']['Female']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_month']['Total']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_quarter']['Male']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_quarter']['Female']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_quarter']['Total']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_year']['Male']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_year']['Female']) ?: $default ?></td>
				<td style="<?= $tr ?>"><?= Html::number($emergency_welfare_program['current_year']['Total']) ?: $default ?></td>
			</tr>

			<tr>
				<td style="<?= $fwbr_tc ?>">Senior Citizen ID Application</td>
			...
			<tr>
				<td style="<?= $fwbr_tc ?>">Social Pension</td>
			...
			<tr>
				<td style="<?= $fwbr_tc ?>">Death Assistance</td>
			...
			<tr>
				<td style="<?= $fwbr_tc ?>">Certificate of Indigency</td>
			...
			<tr>
				<td style="<?= $fwbr_tc ?>">Financial Certification</td>
			...
			<tr>
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_week']['Male'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_week']['Female'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_week']['Total'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_month']['Male'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_month']['Female'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_month']['Total'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_quarter']['Male'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_quarter']['Female'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_quarter']['Total'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_year']['Male'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_year']['Female'] ?: $default)
				...
				<td class="text-right">
					<?= Html::number(
						($emergency_welfare_program['current_year']['Total'] ?: $default)
