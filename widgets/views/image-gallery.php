...
$js = <<< JS
    var selectedImage = {
        ...
        imageViewBtn = [container, '.td-view-btn'].join(' '),
        ...
        cropImageViewBtn = [container, '.crop-td-view-btn'].join(' '),
        ...
        paginationLink = [container, '.app-linkpager-btn'].join(' '),
    ...
    $(document).on('click', images, function() {
        ...
        $(imageViewBtn).html('<a target="_blank" href="'+ $(this).data('viewer_url') +'" class="btn btn-sm btn-primary font-weight-bold">View</a>');
    ...
    $(document).on('click', editBtn, function() {
        ...
        $(cropImageViewBtn).html($(imageViewBtn).html());
    });
                    ...
                    <div >
                        ...
                        <div class="tab-content pt-10">
                            ...
                            <div class="tab-pane fade webcam-tab-container" id="webcam-tab-<?= $id ?>" role="tabpanel">
                                <?= Webcam::widget([
                                    'initFunction' => <<< JS
                                        $(document).on('click', "#image-gallery-container-{$id} .webcam-tab-link", function() {
                                            initCamera();
                                        });
                                    JS,
                                    'tag' => $tag,
