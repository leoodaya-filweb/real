	...
	<table class="table-summary <?= $tableClass ?>" style="width: 100%;">
       ...
       ?>
			...
			<tr>
				...
				<td style="<?= $tr ?>"><?= Html::number($data[$row['username']]['current_week']['Total_Amount']) ?: $default ?></td>
				...
				<td style="<?= $tr ?>"><?= Html::number($data[$row['username']]['current_month']['Total_Amount']) ?: $default ?></td>
				...
				<td style="<?= $tr ?>"><?= Html::number($data[$row['username']]['current_quarter']['Total_Amount']) ?: $default ?></td>
				...
				<td style="<?= $tr ?>"><?= Html::number($data[$row['username']]['current_year']['Total_Amount']) ?: $default ?></td>
			</tr>
    <?php 
