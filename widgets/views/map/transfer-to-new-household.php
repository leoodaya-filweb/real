		...
		google.maps.event.addListener(map, 'click', function(event) {
			...
			elevator
				...
				.then(({ results }) => {
					...
					// });
					$("#transfertonewhouseholdform-longitude").val(location.lng());
					$("#transfertonewhouseholdform-latitude").val(location.lat());
					$("#transfertonewhouseholdform-altitude").val(results[0].elevation)
				});
