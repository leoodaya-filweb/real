...
class ClientcategorySummary extends BaseWidget
{
    public $data;
    public $title;
    public $tableClass;
    ...
    public function init()
    {
        ...
        $this->data = $this->data ?: $this->searchModel->client_category_data();
    }

    public function run()
    {
        $staff_tpl = 'client-category-summary';
       // $staff_tpl = Yii::$app->request->get('transaction_type')==6?'staff-summary-cert':'staff-summary';
        
        return $this->render($staff_tpl, [
            'data' => $this->data,
