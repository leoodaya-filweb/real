...
<div class="card card-custom gutter-b latest-transactions">
	...
	<div class="card-body pt-5">
		<?= Html::ifElse($transactions, function() use($transactions) {
			$data = Html::foreach($transactions, function($transaction) {
				$member = $transaction->member;
				$date = date('F d, Y', strtotime($transaction->createdAt));
				return <<< HTML
					<tr>
						<td class="text-center">
							<div class="symbol symbol-35 flex-shrink-0 symbol-circle">
								{$member->image}
							</div>
						</td>
						<td class="">
							<div class="d-flex flex-column flex-grow-1">
								<a href="{$transaction->viewUrl}" class="text-dark text-hover-primary font-weight-bolder font-size-lg">
									{$member->fullname}
								</a>
						...
						<td class="text-center">
							<span class="">{$transaction->statusBadge}</span>
						</td>
						<td class="text-center">
				...
				<table class="table table-borderless">
					<thead>
						<tr>
							...
							<th class="text-center" width="29%">DATE</th>
							<th class="text-center" width="29%">STATUS</th>
							<th></th>
						</tr>
					</thead>
					<tbody>
