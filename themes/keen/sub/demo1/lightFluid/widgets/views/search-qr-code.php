...
$this->registerWidgetJs($widgetFunction, <<< JS
	...
	$('#btn-create-{$widgetId}').click(function() {
	    //alert();
	    if($('input[name="qr_id-{$widgetId}"]').val()!=""){
	      viewMember();  
	    }else{
	      viewMemberByName();   
	    }
	...
	<div class="search-qr-code">
		...
		<?= Autocomplete::widget([
			...
			'input' => <<< HTML
				...
				<div class="text-right"><button type="button" class="btn btn-primary btn-md image-gallery-btn" id="btn-create-{$widgetId}" >Choose Transaction Type</button></div>
			HTML,
