...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    <!--begin::Brand-->
    <div class="brand flex-column-auto" id="kt_brand" style="height: 80px;">
        <!--begin::Logo-->
        <a href="<?= Url::to(['site/home']) ?>" class="brand-logo" style="padding-top: 10px;">
            <?= Html::image(App::setting('image')->brand_logo, [
            'h' => 95, 
            'quality' => 90
            ], 
            [
