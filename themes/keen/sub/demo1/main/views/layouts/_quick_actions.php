...
<div class="dropdown mr-1">
    ...
    <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
        <div class="d-flex flex-column flex-center py-10 rounded-to border-bottom">
            <h4 class="text-dark font-weight-bold">Quick Create</h4>
        </div>
        <div class="row row-paddingless">
            <div class="col-6">
                <?= Html::a(<<< HTML
                    ...
                    <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Transactions</span>
                    <span class="d-block text-dark-50 font-size-lg">Assistance</span>
            ...
            <div class="col-6">
                <?= Html::a(<<< HTML
                    ...
                    <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Households</span>
                    <span class="d-block text-dark-50 font-size-lg">
                        Residents
                    </span>
                HTML, (new Household())->createUrl, [
            ...
            <div class="col-6">
                <?= Html::a(<<< HTML
                    ...
                    <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Events</span>
                    <span class="d-block text-dark-50 font-size-lg">
                        Program
                    </span>
                HTML, (new Event())->createUrl, [
