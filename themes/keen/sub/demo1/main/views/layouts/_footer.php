    ...
    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="#" target="_blank" class="text-dark-75 text-hover-primary">
                <a href="https://accessgov.ph" target="_blank">AccessGov</a> Assistance Portal licensed to the 
                <a href="https://realquezon.gov.ph" target="_blank">Municipality of Real, Quezon Province</a>
            </a>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
