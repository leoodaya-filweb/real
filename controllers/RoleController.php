...
class RoleController extends Controller
{
     ...
     * @return mixed
     */
    public function actionCreate($tab = 'main')
    {
        $model = new Role();
     ...
     * @throws ForbiddenHttpException if the model cannot be found
     */
    public function actionDuplicate($slug, $tab='main')
    {
     ...
     * @throws ForbiddenHttpException if the model cannot be found
     */
    public function actionUpdate($slug, $tab='main')
    {
        $model = Role::controllerFind($slug, 'slug');
    ...
    public function actionMyRole($tab='main')
    {
        App::info('This data is highly confidential and used by security!');
