...
class TransactionLogController extends Controller 
{
    ...
    {
        return $this->asJson(
            TransactionLog::findByKeywords($keywords, ['id'])
        );
    }
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search(['TransactionLogSearch' => App::queryParams()]);
    ...
    public function actionView($id)
    {
        return $this->render('view', [
            'model' => TransactionLog::controllerFind($id),
        ]);
    }
    ...
    /**
     * Duplicates a new TransactionLog model.
     * If duplication is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionDuplicate($id)
    {
        $originalModel = TransactionLog::controllerFind($id);
        $model = new TransactionLog();
